...
public struct PromotionCode: Sendable, Codable {
...
public struct PromotionCodeRestrictions: Sendable, Codable {
...
public struct PromotionCodeRestrictionsCurrencyOptions: Sendable, Codable {
    /// Minimum amount required to redeem this Promotion Code into a Coupon (e.g., a purchase must be $100 or more to work).
    public var minimumAmount: Int?
...
public struct PromotionCodeList: Sendable, Codable {
    public var object: String
