...
public struct MarketingFeature: Sendable, Codable {
    public var name: String?
...
public struct ProductPackageDimensions: Sendable, Codable {
    /// Height, in inches.
...
public struct ProductSearchResult: Sendable, Codable {
...
public struct ProductsList: Sendable, Codable {
    public var object: String
    public var hasMore: Bool?
    public var url: String?
    public var data: [Product]?
