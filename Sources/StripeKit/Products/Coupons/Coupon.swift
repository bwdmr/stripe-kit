...
public struct Coupon: Sendable, Codable {
...
public struct CouponAppliesTo: Sendable, Codable {
...
public struct CouponCurrencyOptions: Sendable, Codable {
    /// Amount (in the currency specified) that will be taken off the subtotal of any invoices for this customer.
    public var amountOff: Int?
...
public enum CouponDuration: String, Sendable, Codable {
...
public struct CouponList: Sendable, Codable {
    public var object: String
