...
public struct Cardholder: Sendable, Codable {
...
public struct CardholderSpendingControls: Sendable, Codable {
...
public struct CardholderSpendingControlSpendingLimit: Sendable, Codable {
...
public enum CardholderSpendingControlSpendingLimitInterval: String, Sendable, Codable {
...
public struct CardholderBilling: Sendable, Codable {
    /// The cardholder’s billing address.
...
public struct CardholderCompany: Sendable, Codable {
...
public struct CardholderIndividual: Sendable, Codable {
...
public struct CardholderIndividualCardIssuing: Sendable, Codable {
...
public struct CardholderIndividualCardIssuingUserTermsAcceptance: Sendable, Codable {
...
public struct CardholderIndividualVerification: Sendable, Codable {
...
public struct CardholderIndividualVerificationDocument: Sendable, Codable {
...
public struct CardholderAuthorizationRequirements: Sendable, Codable {
...
public enum CardholderStatus: String, Sendable, Codable {
...
public enum CardholderType: String, Sendable, Codable {
...
public enum CardholderAuthorizationRequirementsDisabledReason: String, Sendable, Codable {
...
public enum CardholderAuthorizationRequirementsPastDue: String, Sendable, Codable {
...
public struct CardholderList: Sendable, Codable {
    public var object: String
