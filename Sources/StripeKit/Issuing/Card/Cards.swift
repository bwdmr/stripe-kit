...
public struct IssuingCard: Sendable, Codable {
...
public struct IssuingCardList: Sendable, Codable {
    public var object: String
...
public struct IssuingCardSpendingControls: Sendable, Codable {
...
public enum IssuingCardReplacementReason: String, Sendable, Codable {
...
public struct IssuingCardShipping: Sendable, Codable {
    /// Shipping address.
...
public struct IssuingCardShippingCustom: Sendable, Codable {
...
public enum IssuingCardShippingCarrier: String, Sendable, Codable {
    /// FedEx
    case fedex
    /// USPS
    case usps
...
public enum IssuingCardShippingService: String, Sendable, Codable {
...
public enum IssuingCardShippingStatus: String, Sendable, Codable {
...
public enum IssuingCardShippingType: String, Sendable, Codable {
...
public enum IssuingCardStatus: String, Sendable, Codable {
...
public enum IssuingCardType: String, Sendable, Codable {
...
public enum IssuingCardCancellationReason: String, Sendable, Codable {
    /// The card was lost.
    case lost
    /// The card was stolen.
    case stolen
...
public struct IssuingCardWallets: Sendable, Codable {
    /// Apple Pay Details
...
public struct IssuingCardWalletsApplePay: Sendable, Codable {
...
public enum IssuingCardWalletsApplePayIneligibleReason: String, Sendable, Codable {
...
public struct IssuingCardWalletsGooglePay: Sendable, Codable {
...
public enum IssuingCardWalletsGooglePayIneligibleReason: String, Sendable, Codable {
