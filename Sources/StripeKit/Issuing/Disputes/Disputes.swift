...
public struct IssuingDispute: Sendable, Codable {
...
public struct IssuingDisputeList: Sendable, Codable {
    public var object: String
...
public struct IssuingDisputeEvidence: Sendable, Codable {
...
public struct IssuingDisputeEvidenceCanceled: Sendable, Codable {
...
public enum IssuingDisputeEvidenceCanceledProductType: String, Sendable, Codable {
...
public enum IssuingDisputeEvidenceCanceledReturnStatus: String, Sendable, Codable {
...
public struct IssuingDisputeEvidenceDuplicate: Sendable, Codable {
    /// (ID of a file upload) Additional documentation supporting the dispute.
    @Expandable<File> public var additionalDocumentation: String?
...
public struct IssuingDisputeEvidenceFraudulent: Sendable, Codable {
    /// (ID of a file upload) Additional documentation supporting the dispute.
    @Expandable<File> public var additionalDocumentation: String?
    /// Explanation of why the cardholder is disputing this transaction.
    public var explanation: String?
...
public struct IssuingDisputeEvidenceMerchandiseNotAsDescribed: Sendable, Codable {
    /// (ID of a file upload) Additional documentation supporting the dispute.
    @Expandable<File> public var additionalDocumentation: String?
    /// Explanation of why the cardholder is disputing this transaction.
    public var explanation: String?
...
public enum IssuingDisputeEvidenceMerchandiseNotAsDescribedReturnStatus: String, Sendable, Codable {
    /// The merchant accepted the return.
    case successful
    /// The merchant rejected the return.
    case merchantRejected = "merchant_rejected"
...
public struct IssuingDisputeEvidenceNotReceived: Sendable, Codable {
    /// (ID of a file upload) Additional documentation supporting the dispute.
    @Expandable<File> public var additionalDocumentation: String?
    /// Date when the cardholder expected to receive the product.
    public var expectedAt: Date?
...
public enum IssuingDisputeEvidenceNotReceivedProductType: String, Sendable, Codable {
    /// Tangible goods such as groceries and furniture.
    case merchandise
    /// Intangible goods such as domain name registration, flights and lessons.
    case service
...
public struct IssuingDisputeEvidenceOther: Sendable, Codable {
    /// (ID of a file upload) Additional documentation supporting the dispute.
    @Expandable<File> public var additionalDocumentation: String?
    /// Explanation of why the cardholder is disputing this transaction.
    public var explanation: String?
...
public enum IssuingDisputeEvidenceOtherProductType: String, Sendable, Codable {
    /// Tangible goods such as groceries and furniture.
    case merchandise
    /// Intangible goods such as domain name registration, flights and lessons.
    case service
...
public enum IssuingDisputeEvidenceReason: String, Sendable, Codable {
...
public struct IssuingDisputeEvidenceServiceNotAsDescribed: Sendable, Codable {
    /// (ID of a file upload) Additional documentation supporting the dispute.
    @Expandable<File> public var additionalDocumentation: String?
    /// Date when order was canceled.
    public var canceledAt: Date?
...
public enum IssuingDisputeStatus: String, Sendable, Codable {
    /// The dispute is won.
    case won
    /// The dispute is lost.
    case lost
