...
public struct PaymentLink: Sendable, Codable {
...
public struct PaymentLinkLineItem: Sendable, Codable {
    /// Unique identifier for the object.
    public var id: String
    /// String representing the object’s type. Objects of the same type share the same value.
    public var object: String
...
public struct PaymentLinkLineItemDiscount: Sendable, Codable {
...
public struct PaymentLinkLineItemTax: Sendable, Codable {
...
public struct PaymentLinkLineItemList: Sendable, Codable {
...
public struct PaymentLinkAfterCompletion: Sendable, Codable {
...
public struct PaymentLinkAfterCompletionHostedConfirmation: Sendable, Codable {
...
public struct PaymentLinkAfterCompletionRedirect: Sendable, Codable {
...
public enum PaymentLinkAfterCompletionType: String, Sendable, Codable {
...
public struct PaymentLinkAutomaticTax: Sendable, Codable {
...
public enum PaymentLinkBillingAddressCollection: String, Sendable, Codable {
...
public struct PaymentLinkConsentCollection: Sendable, Codable {
...
public struct PaymentLinkCustomField: Sendable, Codable {
...
public struct PaymentLinkCustomFieldDropdown: Sendable, Codable {
...
public struct PaymentLinkCustomFieldDropdownOption: Sendable, Codable {
...
public struct PaymentLinkCustomFieldLabel: Sendable, Codable {
...
public enum PaymentLinkCustomFieldLabelType: String, Sendable, Codable {
    /// Set a custom label for the field.
    case custom
}

public struct PaymentLinkCustomFieldNumeric: Sendable, Codable {
...
public struct PaymentLinkCustomFieldText: Sendable, Codable {
    /// The maximum character length constraint for the customer’s input.
    public var maximumLength: Int?
    /// The minimum character length requirement for the customer’s input.
    public var minimumLength: Int?
...
public enum PaymentLinkCustomFieldType: String, Sendable, Codable {
...
public struct PaymentLinkCustomText: Sendable, Codable {
...
public struct PaymentLinkCustomTextShippingAddress: Sendable, Codable {
...
public struct PaymentLinkCustomTextSubmit: Sendable, Codable {
    /// Text may be up to 1000 characters in length.
    public var message: String?
...
public enum PaymentLinkCustomerCreation: String, Sendable, Codable {
...
public struct PaymentLinkInvoiceCreation: Sendable, Codable {
...
public struct PaymentLinkInvoiceCreationInvoiceData: Sendable, Codable {
...
public struct PaymentLinkInvoiceCreationInvoiceDataCustomFields: Sendable, Codable {
...
public struct PaymentLinkInvoiceCreationInvoiceDataRenderingOptions: Sendable, Codable {
...
public struct PaymentLinkPaymentIntentData: Sendable, Codable {
...
public enum PaymentLinkPaymentIntentDataCaptureMethod: String, Sendable, Codable {
...
public enum PaymentLinkPaymentIntentDataSetupFutureUsage: String, Sendable, Codable {
...
public enum PaymentLinkPaymentMethodCollection: String, Sendable, Codable {
...
public struct PaymentLinkPhoneNumberCollection: Sendable, Codable {
...
public struct PaymentLinkShippingAddressCollection: Sendable, Codable {
...
public struct PaymentLinkShippingOption: Sendable, Codable {
...
public enum PaymentLinkSubmitType: String, Sendable, Codable {
    case auto
    case book
    case donate
    case pay
...
public struct PaymentLinkSubscriptionData: Sendable, Codable {
...
public struct PaymentLinkTaxIdCollection: Sendable, Codable {
...
public struct PaymentLinkTransferData: Sendable, Codable {
...
public struct PaymentLinkList: Sendable, Codable {
    /// String representing the object’s type. Objects of the same type share the same value. Always has the value `list`.
    public var object: String
    /// Details about each object.
