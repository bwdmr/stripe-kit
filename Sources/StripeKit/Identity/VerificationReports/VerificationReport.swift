...
public struct VerificationReportDocument: Sendable, Codable {
...
public struct VerificationReportDocumentError: Sendable, Codable {
...
public enum VerificationReportDocumentErrorCode: String, Sendable, Codable {
...
public enum VerificationReportDocumentStatus: String, Sendable, Codable {
...
public enum VerificationReportDocumentType: String, Sendable, Codable {
...
public struct VerificationReportIdNumber: Sendable, Codable {
    /// Date of birth.
    /// This field is not included by default. To include it in the response, expand the `dob` field.
    public var dob: PersonDOB?
    /// Details on the verification error. Present when status is `unverified`.
...
public struct VerificationReportIdNumberError: Sendable, Codable {
    /// A short machine-readable string giving the reason for the verification failure.
...
public enum VerificationReportIdNumberErrorReason: String, Sendable, Codable {
...
public enum VerificationReportIdNumberType: String, Sendable, Codable {
...
public enum VerificationReportIdNumberStatus: String, Sendable, Codable {
    /// The check resulted in a successful verification.
    case verified
    /// The data being checked was not able to be verified.
    case unverified
...
public struct VerificationReportOptions: Sendable, Codable {
...
public struct VerificationReportOptionsDocument: Sendable, Codable {
...
public enum VerificationReportOptionsDocumentAllowedType: String, Sendable, Codable {
    /// Drivers license document type.
    case drivingLicense = "driving_license"
    /// Passport document type.
    case passport
...
public struct VerificationReportOptionsIdNumber: Sendable, Codable {
    public init() {}
}

public struct VerificationReportSelfie: Sendable, Codable {
...
public struct VerificationReportSelfieError: Sendable, Codable {
    /// A short machine-readable string giving the reason for the verification failure.
...
public enum VerificationReportSelfieErrorCode: String, Sendable, Codable {
...
public enum VerificationReportSelfieStatus: String, Sendable, Codable {
    /// The check resulted in a successful verification.
    case verified
    /// The data being checked was not able to be verified.
    case unverified
...
public enum VerificationReportType: String, Sendable, Codable {
...
public struct VerificationReportList: Sendable, Codable {
    public var object: String
