...
public struct Secret: Sendable, Codable {
...
public struct SecretScope: Sendable, Codable {
...
public enum SecretScopeType: String, Sendable, Codable {
...
public struct SecretList: Sendable, Codable {
    public var object: String
