...
public struct AccountLink: Sendable, Codable {
...
public enum AccountLinkCreationType: String, Sendable, Codable {
...
public enum AccountLinkCreationCollectType: String, Sendable, Codable {
