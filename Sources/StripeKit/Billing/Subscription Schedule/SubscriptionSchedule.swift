...
public struct SubscriptionSchedule: Sendable, Codable {
...
public struct SubscriptionScheduleCurrentPhase: Sendable, Codable {
...
public struct SubscriptionScheduleDefaultSettings: Sendable, Codable {
...
public struct SubscriptionScheduleDefaultSettingsAutomaticTax: Sendable, Codable {
...
public enum SubscriptionScheduleCollectionMethod: String, Sendable, Codable {
    case chargeAutomatically = "charge_automatically"
    case sendInvoice = "send_invoice"
}

public enum SubscriptionScheduleEndBehavior: String, Sendable, Codable {
    case release
    case cancel
}

public struct SubscriptionScheduleDefaultSettingsBillingThresholds: Sendable, Codable {
...
public struct SubscriptionScheduleInvoiceSettings: Sendable, Codable {
...
public struct SubscriptionScheduleTransferData: Sendable, Codable {
...
public struct SubscriptionSchedulePhase: Sendable, Codable {
...
public struct SubscriptionSchedulePhaseAddInvoiceItem: Sendable, Codable {
...
public struct SubscriptionSchedulePhaseAutomaticTax: Sendable, Codable {
    /// Whether Stripe automatically computes tax on invoices created during this phase.
    public var enabled: Bool?
...
public struct SubscriptionSchedulePhaseItem: Sendable, Codable {
...
public struct SubscriptionSchedulePhaseItemBillingThresholds: Sendable, Codable {
...
public struct SubscriptionSchedulePhaseTransferData: Sendable, Codable {
    /// A non-negative decimal between 0 and 100, with at most two decimal places. This represents the percentage of the subscription invoice subtotal that will be transferred to the destination account. By default, the entire amount is transferred to the destination.
    public var amountPercent: Int?
    /// The account where funds from the payment will be transferred to upon payment success.
    @Expandable<ConnectAccount> public var destination: String?
...
public enum SubscriptionScheduleBillingCycleAnchor: String, Sendable, Codable {
    case phaseStart = "phase_start"
    case automatic
}

public enum SubscriptionScheduleStatus: String, Sendable, Codable {
...
public enum SubscriptionSchedulePhaseProrationBehavior: String, Sendable, Codable {
    case createProrations = "create_prorations"
    case alwaysInvoice = "always_invoice"
    case none
}

public struct SubscriptionScheduleList: Sendable, Codable {
    public var object: String
