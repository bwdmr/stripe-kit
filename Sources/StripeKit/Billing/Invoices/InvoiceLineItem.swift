...
public struct InvoiceLineItem: Sendable, Codable {
...
public struct InvoiceLineItemPeriod: Sendable, Codable {
...
public enum InvoiceLineItemType: String, Sendable, Codable {
    case invoiceitem
    case subscription
}

public struct InvoiceLineItemDiscountAmount: Sendable, Codable {
...
public struct InvoiceLineItemProrationDetails: Sendable, Codable {
...
public struct InvoiceLineItemProrationDetailsCreditedItem: Sendable, Codable {
...
public struct InvoiceLineItemList: Sendable, Codable {
    public var object: String
...
public struct InvoiceSearchResult: Sendable, Codable {
