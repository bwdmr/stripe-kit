...
public struct InvoicePaymentSettingsPaymentMethodOptions: Sendable, Codable {
...
// MARK: ACSS Debit
public struct InvoicePaymentSettingsPaymentMethodOptionsAcssDebit: Sendable, Codable {
...
public struct InvoicePaymentSettingsPaymentMethodOptionsAcssDebitManadteOptions: Sendable, Codable {
...
public enum InvoicePaymentSettingsPaymentMethodOptionsAcssDebitManadteOptionsTransactionType: String, Sendable, Codable {
...
public enum InvoicePaymentSettingsPaymentMethodOptionsAcssDebitVerificationMethod: String, Sendable, Codable {
...
// MARK: Bancontact
public struct InvoicePaymentSettingsPaymentMethodOptionsBancontact: Sendable, Codable {
...
// MARK: Card
public struct InvoicePaymentSettingsPaymentMethodOptionsCard: Sendable, Codable {
...
public struct InvoicePaymentSettingsPaymentMethodOptionsCardInstallments: Sendable, Codable {
...
public enum InvoicePaymentSettingsPaymentMethodOptionsCardRequestThreedSecure: String, Sendable, Codable {
...
public struct InvoicePaymentSettingsPaymentMethodOptionsCustomerBalance: Sendable, Codable {
...
public struct InvoicePaymentSettingsPaymentMethodOptionsCustomerBalanceBankTransfer: Sendable, Codable {
...
public struct InvoicePaymentSettingsPaymentMethodOptionsCustomerBalanceBankTransferEUBankTransfer: Sendable, Codable {
...
public enum InvoicePaymentSettingsPaymentMethodOptionsCustomerBalanceBankTransferType: String, Sendable, Codable {
...
public enum InvoicePaymentSettingsPaymentMethodOptionsCustomerBalanceFundingType: String, Sendable, Codable {
    case bankTransfer = "bank_transfer"
}

// MARK: Konbini
public struct InvoicePaymentSettingsPaymentMethodOptionsKonbini: Sendable, Codable {
    public init(){}
}

// MARK: US Bank Account
public struct InvoicePaymentSettingsPaymentMethodOptionsUSBankAccount: Sendable, Codable {
...
public struct InvoicePaymentSettingsPaymentMethodOptionsUSBankAccountFinancialConnections: Sendable, Codable {
...
public enum InvoicePaymentSettingsPaymentMethodOptionsUSBankAccountFinancialConnectionsPermission: String, Sendable, Codable {
...
public enum InvoicePaymentSettingsPaymentMethodOptionsUSBankAccountVerificationMethod: String, Sendable, Codable {
    /// Instant verification with fallback to microdeposits.
    case automatic
