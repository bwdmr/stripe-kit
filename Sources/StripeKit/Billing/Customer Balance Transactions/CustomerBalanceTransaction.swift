...
public struct CustomerBalanceTransaction: Sendable, Codable {
...
public enum CustomerBalanceTransactionType: String, Sendable, Codable {
    case adjustment
...
public struct CustomerBalanceTransactionList: Sendable, Codable {
    public var object: String
