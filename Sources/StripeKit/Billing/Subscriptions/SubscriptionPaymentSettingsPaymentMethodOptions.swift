...
public struct SubscriptionPaymentSettingsPaymentMethodOptions: Sendable, Codable {
...
// MARK: ACSS Debit
public struct SubscriptionPaymentSettingsPaymentMethodOptionsAcssDebit: Sendable, Codable {
...
public struct SubscriptionPaymentSettingsPaymentMethodOptionsAcssDebitManadteOptions: Sendable, Codable {
...
public enum SubscriptionPaymentSettingsPaymentMethodOptionsAcssDebitManadteOptionsTransactionType: String, Sendable, Codable {
...
public enum SubscriptionPaymentSettingsPaymentMethodOptionsAcssDebitVerificationMethod: String, Sendable, Codable {
...
// MARK: Bancontact
public struct SubscriptionPaymentSettingsPaymentMethodOptionsBancontact: Sendable, Codable {
...
// MARK: Card
public struct SubscriptionPaymentSettingsPaymentMethodOptionsCard: Sendable, Codable {
...
public struct SubscriptionPaymentSettingsPaymentMethodOptionsCardMandateOptions: Sendable, Codable {
...
public enum SubscriptionPaymentSettingsPaymentMethodOptionsCardMandateOptionsAmountType: String, Sendable, Codable {
...
public enum SubscriptionPaymentSettingsPaymentMethodOptionsCardRequestThreedSecure: String, Sendable, Codable {
...
public struct SubscriptionPaymentSettingsPaymentMethodOptionsCustomerBalance: Sendable, Codable {
...
public struct SubscriptionPaymentSettingsPaymentMethodOptionsCustomerBalanceBankTransfer: Sendable, Codable {
...
public struct SubscriptionPaymentSettingsPaymentMethodOptionsCustomerBalanceBankTransferEUBankTransfer: Sendable, Codable {
...
public enum SubscriptionPaymentSettingsPaymentMethodOptionsCustomerBalanceBankTransferType: String, Sendable, Codable {
...
public enum SubscriptionPaymentSettingsPaymentMethodOptionsCustomerBalanceFundingType: String, Sendable, Codable {
    case bankTransfer = "bank_transfer"
}

// MARK: Konbini
public struct SubscriptionPaymentSettingsPaymentMethodOptionsKonbini: Sendable, Codable {
    public init(){}
}

// MARK: US Bank Account
public struct SubscriptionPaymentSettingsPaymentMethodOptionsUSBankAccount: Sendable, Codable {
...
public struct SubscriptionPaymentSettingsPaymentMethodOptionsUSBankAccountFinancialConnections: Sendable, Codable {
...
public enum SubscriptionPaymentSettingsPaymentMethodOptionsUSBankAccountFinancialConnectionsPermission: String, Sendable, Codable {
...
public enum SubscriptionPaymentSettingsPaymentMethodOptionsUSBankAccountVerificationMethod: String, Sendable, Codable {
    /// Instant verification with fallback to microdeposits.
    case automatic
