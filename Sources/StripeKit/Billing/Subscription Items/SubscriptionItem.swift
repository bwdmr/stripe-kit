...
public struct SubscriptionItem: Sendable, Codable {
...
public struct SubscriptionItemBillingThresholds: Sendable, Codable {
...
public enum SubscriptionItemPaymentBehavior: String, Sendable, Codable {
...
public enum SubscriptionItemProrationBehavior: String, Sendable, Codable {
    case createProrations = "create_prorations"
    case alwaysInvoice = "always_invoice"
    case none
}

public struct SubscriptionItemList: Sendable, Codable {
    public var object: String
