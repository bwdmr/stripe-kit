...
// MARK: ACSS Debit
public struct PaymentMethodAcssDebit: Sendable, Codable {
...
// MARK: Affirm
public struct PaymentMethodAffirm: Sendable, Codable {
    public init(){}
}

// MARK: Afterpay Clearpay
public struct PaymentMethodAfterpayClearpay: Sendable, Codable {
    public init(){}
}

// MARK: Alipay
public struct PaymentMethodAlipay: Sendable, Codable {
    public init(){}
}

// MARK: AU Becs Debit
public struct PaymentMethodAuBecsDebit: Sendable, Codable {
...
// MARK: Bacs Debit
public struct PaymentMethodBacsDebit: Sendable, Codable {
    /// Uniquely identifies this particular bank account. You can use this attribute to check whether two bank accounts are the same.
    public var fingerprint: String?
    /// Last four digits of the bank account number
    public var last4: String?
...
// MARK: Bancontact
public struct PaymentMethodBancontact: Sendable, Codable {
    public init(){}
}

// MARK: Blik
public struct PaymentMethodBlik: Sendable, Codable {
    public init(){}
}

// MARK: Boleto
public struct PaymentMethodBoleto: Sendable, Codable {
    public var fingerprint: String?
...
// MARK: Card
public struct PaymentMethodCard: Sendable, Codable {
...
public enum PaymentMethodDetailsCardBrand: String, Sendable, Codable {
    case amex
    case diners
    case discover
...
public enum PaymentMethodCardNetwork: String, Sendable, Codable {
    case amex
...
public struct PaymentMethodDetailsCardChecks: Sendable, Codable {
...
public struct PaymentMethodCardGeneratedFrom: Sendable, Codable {
...
public struct PaymentMethodCardGeneratedFromPaymentMethodDetails: Sendable, Codable {
...
public struct PaymentMethodCardGeneratedFromPaymentMethodDetailsCardPresent: Sendable, Codable {
...
public enum PaymentMethodCardGeneratedFromPaymentMethodDetailsCardPresentReadMethod: String, Sendable, Codable {
...
public struct PaymentMethodCardGeneratedFromPaymentMethodDetailsCardPresentReceipt: Sendable, Codable {
...
public enum PaymentMethodCardGeneratedFromPaymentMethodDetailsCardPresentReceiptAccountType: String, Sendable, Codable {
...
public struct PaymentMethodCardNetworks: Sendable, Codable {
...
public struct PaymentMethodCardThreeDSecureUsage: Sendable, Codable {
...
public struct PaymentMethodCardWallet: Sendable, Codable {
...
public struct PaymentMethodCardWalletAmexExpressCheckout: Sendable, Codable {
    public init() {}
}

public struct PaymentMethodCardWalletApplePay: Sendable, Codable {
    public var type: String?
...
public struct PaymentMethodCardWalletGooglePay: Sendable, Codable {
    public init() {}
}

public struct PaymentMethodCardWalletMasterPass: Sendable, Codable {
...
public struct PaymentMethodCardWalletSamsungPay: Sendable, Codable {
    public init() {}
}

public enum PaymentMethodDetailsCardWalletType: String, Sendable, Codable {
...
public struct PaymentMethodCardWalletVisaCheckout: Sendable, Codable {
    /// Owner’s verified billing address. Values are verified or provided by the wallet directly (if supported) at the time of authorization or settlement. They cannot be set or mutated.
    public var billingAddress: Address?
    /// Owner’s verified email. Values are verified or provided by the wallet directly (if supported) at the time of authorization or settlement. They cannot be set or mutated.
    public var email: String?
...
// MARK: Card Present
public struct PaymentMethodCardPresent: Sendable, Codable {
    /// Card brand. Can be `amex`, `diners`, `discover`, `jcb`, `mastercard`, `unionpay`, `visa`, or `unknown`.
    public var brand: PaymentMethodDetailsCardBrand?
    /// The cardholder name as read from the card, in ISO 7813 format. May include alphanumeric characters, special characters and first/last name separator (/). In some cases, the cardholder name may not be available depending on how the issuer has configured the card. Cardholder name is typically not available on swipe or contactless payments, such as those made with Apple Pay and Google Pay.
    public var cardholderName: String?
...
public enum PaymentMethodCardPresentReadMethod: String, Sendable, Codable {
    /// Inserting a chip card into the card reader.
    case contactEmv = "contact_emv"
    /// Tapping a contactless-enabled chip card or mobile wallet.
    case contactlessEmv = "contactless_emv"
...
// MARK: Cashapp
public struct PaymentMethodCashapp: Sendable, Codable {
    public init() { }
}

// MARK: CustomerBalance
public struct PaymentMethodCustomerBalance: Sendable, Codable {
    public init() { }
}

// MARK: EPS
public struct PaymentMethodEps: Sendable, Codable {
...
public enum PaymentMethodEpsBank: String, Sendable, Codable {
...
// MARK: FPX
public struct PaymentMethodFpx: Sendable, Codable {
    /// The customer’s bank, if provided. Can be one of `affin_bank`, `agrobank`, `alliance_bank`, `ambank`, `bank_islam`, `bank_muamalat`, `bank_rakyat`, `bsn`, `cimb`, `hong_leong_bank`, `hsbc`, `kfh`, `maybank2u`, `ocbc`, `public_bank`, `rhb`, `standard_chartered`, `uob`, `deutsche_bank`, `maybank2e`, `pb_enterprise`, or  `bank_of_china`.
    public var bank: PaymentMethodFpxBank?
}

public enum PaymentMethodFpxBank: String, Sendable, Codable {
...
// MARK: Giropay
public struct PaymentMethodGiropay: Sendable, Codable {
    public init() {}
}

// MARK: Grabpay
public struct PaymentMethodGrabpay: Sendable, Codable {
    public init() {}
}

// MARK: Ideal
public struct PaymentMethodIdeal: Sendable, Codable {
...
public enum PaymentMethodIdealBank: String, Sendable, Codable {
...
// MARK: InteracPresent
public struct PaymentMethodInteractPresent: Sendable, Codable {
...
public enum PaymentMethodInteractPresentReadMethod: String, Sendable, Codable {
    /// Inserting a chip card into the card reader.
    case contactEmv = "contact_emv"
    /// Tapping a contactless-enabled chip card or mobile wallet.
    case contactlessEmv = "contactless_emv"
...
// MARK: Klarna
public struct PaymentMethodKlarna: Sendable, Codable {
...
// MARK: Konbini
public struct PaymentMethodKonbini: Sendable, Codable {
    public init() {}
}

// MARK: Link
public struct PaymentMethodLink: Sendable, Codable {
...
// MARK: OXXO
public struct PaymentMethodOXXO: Sendable, Codable {
    public init() {}
}

// MARK: P24
public struct PaymentMethodP24: Sendable, Codable {
...
public enum PaymentMethodP24Bank: String, Sendable, Codable {
    case ing = "ing"
...
// MARK: Paynow
public struct PaymentMethodPaynow: Sendable, Codable {
    public init() {}
}

// MARK: Pix
public struct PaymentMethodPix: Sendable, Codable {
    public init() {}
}

// MARK: PromptPay
public struct PaymentMethodPromptPay: Sendable, Codable {
    public init() {}
}
 
// MARK: Sepa Debit
public struct PaymentMethodSepaDebit: Sendable, Codable {
...
public struct PaymentMethodSepaDebitGeneratedFrom: Sendable, Codable {
...
// MARK: Sofort
public struct PaymentMethodSofort: Sendable, Codable {
    /// Two-letter ISO code representing the country the bank account is located in.
    public var country: String?
...
public struct PaymentMethodUSBankAccount: Sendable, Codable {
...
public enum PaymentMethodUSBankAccountAccountHolderType: String, Sendable, Codable {
...
public enum PaymentMethodUSBankAccountAccountType: String, Sendable, Codable {
...
public struct PaymentMethodUSBankAccountNetworks: Sendable, Codable {
    /// All available networks for the card.
    public var available: [String]?
    /// The preferred network for the card.
    public var preferred: String?
...
public struct PaymentMethodUSBankAccountStatusDetails: Sendable, Codable {
...
public struct PaymentMethodUSBankAccountStatusDetailsBlocked: Sendable, Codable {
...
public enum PaymentMethodUSBankAccountStatusDetailsBlockedNetwork: String, Sendable, Codable {
    /// Account Closed
    case R02
...
public enum PaymentMethodUSBankAccountStatusDetailsBlockedReason: String, Sendable, Codable {
...
// MARK: WechatPay
public struct PaymentMethodWechatPay: Sendable, Codable {
    public init() {}
}
