...
public struct Card: Sendable, Codable {
...
public enum CardValidationCheck: String, Sendable, Codable {
    case pass
    case fail
    case unavailable
    case unchecked
...
public enum CardBrand: String, Sendable, Codable {
...
public enum CardFundingType: String, Sendable, Codable {
    case credit
    case debit
    case prepaid
    case unknown
...
public enum CardTokenizedMethod: String, Sendable, Codable {
...
public struct CardWallet: Sendable, Codable {
...
public struct CardWalletApplePay: Sendable, Codable {
    public var type: String?
...
public struct CardList: Sendable, Codable {
