...
public struct TerminalHardwareOrder: Sendable, Codable {
...
public struct TerminalHardwareOrderLineItem: Sendable, Codable {
...
public enum TerminalHardwareOrderPaymentType: String, Sendable, Codable {
    case monthlyInvoice = "monthly_invoice"
    case paymentIntent = "payment_intent"
    case `none`
}

public struct TerminalHardwareOrderShipping: Sendable, Codable {
    /// Shipping address.
...
public enum TerminalHardwareOrderStatus: String, Sendable, Codable {
...
public struct TerminalHardwareOrderShipmentTracking: Sendable, Codable {
...
public enum TerminalHardwareOrderShipmentTrackingCarrier: String, Sendable, Codable {
...
public struct TerminalHardwareOrderTotalTaxAmount: Sendable, Codable {
...
public struct TerminalHardwareOrderTotalTaxAmountRate: Sendable, Codable {
...
public struct TerminalHardwareOrderList: Sendable, Codable {
    public var object: String
