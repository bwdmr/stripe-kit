...
public struct Mandate: Sendable, Codable {
...
public struct MandateCustomerAcceptance: Sendable, Codable {
...
public struct MandateCustomerAcceptanceOffline: Sendable, Codable {
    public init() {}
}

public struct MandateCustomerAcceptanceOnline: Sendable, Codable {
...
public enum MandateCustomerAcceptanceType: String, Sendable, Codable {
    case online
    case offline
}

public struct MandatePaymentMethodDetails: Sendable, Codable {
...
public struct MandateSingleUse: Sendable, Codable {
...
public struct MandateMultiUse: Sendable, Codable {
    public init() {}
}

public enum MandateStatus: String, Sendable, Codable {
...
public enum MandateType: String, Sendable, Codable {
