...
public struct Balance: Sendable, Codable {
...
public struct BalanceIssuing: Sendable, Codable {
...
public struct BalanceAmount: Sendable, Codable {
    /// Balance amount.
...
public struct BalanceAmountSourceType: Sendable, Codable {
