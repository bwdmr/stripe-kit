...
public struct CustomerCashBalance: Sendable, Codable {
    /// String representing the object’s type. Objects of the same type share the same value.
    public var object: String
...
public struct CustomerCashBalanceSettings: Sendable, Codable {
...
public struct CustomerInvoiceSettings: Sendable, Codable {
...
public struct CustomerInvoiceSettingsCustomFields: Sendable, Codable {
...
public struct CustomerInvoiceSettingsRenderingOptions: Sendable, Codable {
...
public enum CustomerTaxExempt: String, Sendable, Codable {
    case none
    case exempt
    case reverse
}

public struct CustomerList: Sendable, Codable {
    public var object: String
...
public struct CustomerSearchResult: Sendable, Codable {
